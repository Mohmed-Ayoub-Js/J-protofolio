...
import "./css/bg.css";
const ImageMe = () => {
    const image = "https://lh4.googleusercontent.com/vIXS8pTIZBmvONtnBg9Ge1wcuCExUIDoLWwecElmhAcvYgWL9xgyl0mNcv_pl-vvw5ivm5WKQXpealdQHZUW2Bffy503tq0Rx0OAcEjW7bn1PW46_iQclht0EdMShAQ9Mw=w1280";
  return (
    <div>
  ...
  <span>من انا</span>
  <p class="info">جواد سمنودي و عمره 15 و يعيش في مكة و يمكنك الإستعانة به في امور البرمجة و التصميم و أدارة المتاجر</p>
  <div class="share">
...
//error : style="fill:none;stroke-linecap:round;stroke:#fff;stroke-miterlimit:10;stroke-width:2;opacity:.1"